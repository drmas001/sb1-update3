...
const MyDocument: React.FC<{ patients: Patient[], selectedDate: string }> = ({ patients, selectedDate }) => (
  <Document>
      ...
      <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mt-4">
              <PDFDownloadLink
                document={<MyDocument patients={filteredPatients} selectedDate={selectedDate} />}
